...
public class Silly implements Comparable<Silly>{
    ...
    public boolean equals(Object o) {
        ...
        //       e.g. s1.equals(s2)
        if(other.name.equals(this.name)){ return true; } //return true when the other and this name are equals
        return false;
    }
    ...
    public int compareTo(Silly other) {
         ...
         *                .length() method.
         */
        if(this.name.length() == other.name.length()) {return 0;} //same length
        else if(this.name.length() < other.name.length()) {return -1;} //other name is longer
        return 1; //this.name is longer
    }
